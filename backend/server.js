...
// Eski alan adını yeni alan adına 301 (kalıcı) yönlendir: leaves.smartalpha.dev -> leave.smartalpha.dev
// Yol, sorgu ve HTTPS korunur. Diğer host'lar (leave.smartalpha.dev, Cloud Run URL) etkilenmez.
const OLD_HOST = "leaves.smartalpha.dev";
const NEW_HOST = "leave.smartalpha.dev";
